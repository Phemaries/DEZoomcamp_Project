...
GROUP BY
    delay_travel.delay_id, delay_travel.carrier_delay_minutes, delay_travel.weather_delay_minutes, delay_travel.nas_delay_minutes, 
    delay_travel.security_delay_minutes, delay_travel.late_aircraft_delay_minutes, travels.travel_month, travels.travel_day, 
    origin_airport.origin_city, origin_airport.origin_state, destination_airport.destination_city, 
    destination_airport.destination_state, destination_performance.departure_delay_minutes, 
    destination_performance.taxi_out_minutes, arrival_performance.arrival_delay_minutes, 
    arrival_performance.taxi_in_minutes, carrier.unique_carrier
